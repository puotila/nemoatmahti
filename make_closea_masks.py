...
#=====================================
    ...
    if config == 'ORCA2':
        ...
        ncsnr = np.zeros(num_closea+1,dtype=np.int32)                     ; ncstt = np.zeros(num_closea+1,dtype=np.int32)
        ncsi1 = np.zeros(num_closea+1,dtype=np.int32)                     ; ncsj1 = np.zeros(num_closea+1,dtype=np.int32)
        ncsi2 = np.zeros(num_closea+1,dtype=np.int32)                     ; ncsj2 = np.zeros(num_closea+1,dtype=np.int32)
        ncsir = np.zeros((num_closea+1,max_runoff_points+1),dtype=np.int32) ; ncsjr = np.zeros((num_closea+1,max_runoff_points+1),dtype=np.int32)
    ...
    #================================================================
        ...
        ncsi1 = np.zeros(num_closea+1,dtype=np.int32)                     ; ncsj1 = np.zeros(num_closea+1,dtype=np.int32)
        ncsi2 = np.zeros(num_closea+1,dtype=np.int32)                     ; ncsj2 = np.zeros(num_closea+1,dtype=np.int32)
        ncsir1 = np.zeros(num_closea+1,dtype=np.int32)                    ; ncsjr1 = np.zeros(num_closea+1,dtype=np.int32)
        ncsir2 = np.zeros(num_closea+1,dtype=np.int32)                    ; ncsjr2 = np.zeros(num_closea+1,dtype=np.int32)
        ncsir = np.zeros((num_closea+1,max_runoff_points+1),dtype=np.int32) ; ncsjr = np.zeros((num_closea+1,max_runoff_points+1),dtype=np.int32)
...
#=====================================
    ...
    closea_mask = ma.zeros(top_level.shape,dtype=np.int32)
    temp_mask_rnf = ma.zeros(top_level.shape,dtype=np.int32)
    temp_mask_empmr = ma.zeros(top_level.shape,dtype=np.int32)
    closea_mask_rnf = ma.zeros(top_level.shape,dtype=np.int32)
    closea_mask_empmr = ma.zeros(top_level.shape,dtype=np.int32)
    ...
    for ics in range(num_closea):
        ...
        if ncstt[ics+1] == 1:
            ...
            if min_rnf != max_rnf:
                print(f'min_rnf, max_rnf : {min_rnf}, {max_rnf}')
